<template>
  <div>
    ...
    <div class="container-inner">
      <div v-if="false" class="searchLetter touchClass">
      ...
      <div class="container-city">
        ...
        <scroll-view scroll-y="true" v-bind:style="{height: winHeight + 'px'}" :scroll-into-view="scrollTopId">
          ...
          <div class="selectCity">
            ...
            <div class="thisCityName" :data-city="city" :data-code="currentCityCode" @click="bindCity">{{ city }}</div>
...
import { CITY_GET_LOCATION, CITY_CHANGE_CODE } from '../store/mutation-types'
